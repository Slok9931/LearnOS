                ...
                <div className="space-y-8">
                    <div className="text-center space-y-4">
                        <div className="inline-flex items-center gap-3 text-3xl font-bold text-white">
                            ...
                            OS Virtualization Terminal
                        </div>
                        <p className="text-gray-300 max-w-3xl mx-auto text-lg">
                            Experience CPU virtualization firsthand with our interactive terminal. Learn process management, 
                            system calls, and trap handling in a realistic command-line environment.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-8">
                        <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
                            <CardContent className="p-6 text-center">
                                ...
                                <h3 className="font-semibold text-blue-300 mb-2">System Calls & Traps</h3>
                                <p className="text-sm text-blue-200/80">
                                    Explore trap tables, interrupt handling, and the kernel-user space boundary
                                </p>
                                <div className="mt-3 flex flex-wrap gap-1 justify-center">
                                    <span className="px-2 py-1 bg-blue-500/20 text-blue-300 rounded text-xs">trap</span>
                                    <span className="px-2 py-1 bg-blue-500/20 text-blue-300 rounded text-xs">syscall</span>
                                    <span className="px-2 py-1 bg-blue-500/20 text-blue-300 rounded text-xs">interrupt</span>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20 hover:border-green-500/40 transition-all duration-300">
                            <CardContent className="p-6 text-center">
                                ...
                                <h3 className="font-semibold text-green-300 mb-2">Process Management</h3>
                                <p className="text-sm text-green-200/80">
                                    Fork, exec, wait, kill - master the fundamental process operations with real-time feedback
                                </p>
                                <div className="mt-3 flex flex-wrap gap-1 justify-center">
                                    <span className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-xs">fork</span>
                                    <span className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-xs">wait</span>
                                    <span className="px-2 py-1 bg-green-500/20 text-green-300 rounded text-xs">kill</span>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
                            <CardContent className="p-6 text-center">
                                ...
                                <h3 className="font-semibold text-purple-300 mb-2">Real-time Monitoring</h3>
                                <p className="text-sm text-purple-200/80">
                                    Watch process states, system resources, and scheduling decisions in real-time
                                </p>
                                <div className="mt-3 flex flex-wrap gap-1 justify-center">
                                    <span className="px-2 py-1 bg-purple-500/20 text-purple-300 rounded text-xs">top</span>
                                    <span className="px-2 py-1 bg-purple-500/20 text-purple-300 rounded text-xs">ps</span>
                                    <span className="px-2 py-1 bg-purple-500/20 text-purple-300 rounded text-xs">htop</span>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
